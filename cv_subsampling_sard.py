...
from experiments.datasets.fillup import FillupDataset
...
assert CLASSIFICATION_DATASET["type"] == "Fillup", "This script is only valid for Fillup-Datasets"
...
CLASSIFICATION_DATASET["fill_from"]["overwrite_cache"] = CLASSIFICATION_DATASET["overwrite_cache"]
fill_from_dataset = get_dataset(CLASSIFICATION_DATASET["fill_from"])
...
for percentage in PERCENTAGES:
    ...
    with Logger("results/" + EXPERIMENT_NAME + "/out.log"):
        for i in range(RUNS):
            ...
            dataset = FillupDataset(reduced_dataset, fill_from_dataset, CLASSIFICATION_DATASET)
